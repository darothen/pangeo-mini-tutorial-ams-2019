...
The vast majority of the material herein was adapted from the previously mentioned
AGU tutorial and community-contributed documentation, especially from the xarray, 
Dask, Cartopy, Holoviews, and Geoviews project documentation. Some pieces of text in the xarray portion of this tutorial were adapted from Hoyer and Hamman (2016). 
Integration with and portingto the binder platform was primarily executed by Joe
Hamman, with support from other community members.
